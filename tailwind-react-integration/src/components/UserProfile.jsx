function UserProfile() {
  return (
    <div className="mx-auto my-20 max-w-xs bg-gray-100 rounded-lg shadow-lg p-4 sm:max-w-sm sm:p-4 md:p-8 md:max-w-sm">
      ...
      <h1 className="mt-4 text-lg font-medium md:text-xl sm:text-xl text-blue-800">John Doe</h1>
